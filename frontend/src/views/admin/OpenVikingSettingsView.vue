...
async function loadSettings() {
  ...
  try {
    ...
    form.pluginPackage = settings.pluginPackage || "npm:@claw-manager/openviking-openclaw-plugin@2026.6.34";
    form.identitySalt = "";
    form.rootApiKey = "";
    ...
    <el-card shadow="never" v-loading="loading">
      <el-form label-position="top" class="settings-form">
        ...
        <el-form-item label="OpenViking 插件包">
          <el-input v-model="form.pluginPackage" placeholder="npm:@claw-manager/openviking-openclaw-plugin@2026.6.34" />
        </el-form-item>
