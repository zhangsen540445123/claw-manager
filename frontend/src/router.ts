...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: "/admin/model-presets", name: "admin-model-presets", component: ModelPresetsView, meta: { shellKey: "presets", title: "LLM 模型预设" } },
    { path: "/admin/image-generation", name: "admin-image-generation", component: ImageGenerationSettingsView, meta: { shellKey: "imageGeneration", title: "生图预设" } },
