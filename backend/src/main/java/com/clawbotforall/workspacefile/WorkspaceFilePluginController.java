...
@RestController
public class WorkspaceFilePluginController {
  private final InstanceCommandService instances;
  private final WorkspaceFilePluginService plugins;

  public WorkspaceFilePluginController(InstanceCommandService instances, WorkspaceFilePluginService plugins) {
    this.instances = instances;
    this.plugins = plugins;
  }

  @GetMapping("/api/admin/instances/{id}/workspace-file-plugin")
  ...
  @GetMapping("/api/admin/workspace-file-plugins/versions")
  ...
  @PostMapping("/api/admin/workspace-file-plugins/check")
  ...
  @PostMapping("/api/admin/instances/{id}/workspace-file-plugin/{operation}")
  ...
  @PostMapping("/api/admin/workspace-file-plugins/{operation}")
