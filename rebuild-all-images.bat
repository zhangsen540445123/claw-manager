...
echo ========================================
echo  Claw Manager rebuild runner/API/Web
echo ========================================

call :check_docker || goto fail

echo.
echo [Step 1/3] Building OpenClaw runner image...
call :build_runner_image || goto fail

echo.
echo [Step 2/3] Building API/Web images...
%COMPOSE% build api web
if errorlevel 1 goto fail

echo.
echo [Step 3/3] Restarting API/Web services...
